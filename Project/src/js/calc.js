$(document).ready(function () {
    ...
    function calculate() {
        ...
        let days = parseInt($("#calc-select-a option:selected").attr("days")) + parseInt($("#calc-select-b option:selected").attr("days")) + parseInt($("#calc-select-c option:selected").attr("days"));
        
        let prices = parseInt($("#calc-select-a option:selected").attr("price")) + parseInt($("#calc-select-b option:selected").attr("price")) + parseInt($("#calc-select-c option:selected").attr("price"));
        
        $("#price-id .digit-sum").text(prices);
        $("#days-id .digit-sum").text(days);
    }
...
//Простой тип калькулятора (нерабочий).
/*
let time = 0,
    price = 0;
